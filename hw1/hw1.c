...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    int department = 100*course[3] + 10*course[4] + course[5];
    int courseNo = 100*course[7] + 10*course[8] + course[9];
    ...
    /* Simple formatting. */
    printf("Division: %d\n Department: %d\n Course: %d\n Grade: %d %d\n Credits: %d %d",
        division, department, courseNo, letterGrade, sign, leftDecimal, rightDecimal);
